...
''' 
''' Because the control inherits from ThumbnailSettingsBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' </summary>
''' -----------------------------------------------------------------------------
Public Class Settings
    Inherits ThumbnailSettingsBase
...
#Region "Base Method Implementations"
        ...
        Try
            If (Page.IsPostBack = False) Then
                ...
                If Settings.Contains("PanelName") Then
                    txtName.Text = Settings("PanelName").ToString()
                End If
            End If
    ...
    Public Overrides Sub UpdateSettings()
        Try
            ...
            objModules.UpdateModuleSetting(ModuleId, "PanelName", txtName.Text.Trim().ToString())
        Catch exc As Exception           'Module failed to load
            ProcessModuleLoadException(Me, exc)
        End Try
    End Sub
